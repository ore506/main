...
schools = (
    ...
    School('wci',     'Walnut Creek Intermediate', 32.19752747535466, 34.862920201920836)
)
...
@app.route("/")
def index():
    return render_template('index_g.html', schools=schools)
...
def show_school(school_code):
    ...
    if school:
        return render_template('map_g.html', school=school)
    else:
        abort(404)
